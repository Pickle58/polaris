...
// Used for Agent "UpdateFiles" tool
...
// Used for Agent "CreateFile" tool with batch support
...
// Used for Agent "RenameFile" tool with batch support
...
export const deleteFile = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const deleteRecursive = async (fileId: typeof args.fileId) => {
            ...
            // If it's a folder, delete children first
            if (item.type === "folder") {
